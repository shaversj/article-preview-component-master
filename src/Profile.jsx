  ...
  return (
    <div className={"px-[2.25rem] lg:px-[2.6rem] " + (hideProfileOnSmallScreen ? "sm:hidden lg:block" : "")}>
      <div className={"mt-8 flex items-center justify-center pb-4 lg:-mt-[4.4rem] "}>
        ...
        <button className={"ml-auto grid h-8 w-8 place-items-center rounded-full bg-Light-Grayish-Blue hover:bg-Desaturated-Dark-Blue focus:bg-Desaturated-Dark-Blue"} onClick={handleClick}>
